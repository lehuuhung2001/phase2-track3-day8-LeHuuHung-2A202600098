...
class AgentState(TypedDict, total=False):
    """LangGraph state for the support-ticket workflow.

    Scalar fields (route, attempt, final_answer, etc.) use overwrite semantics.
    List fields (messages, tool_results, errors, events) use append-only reducers
    so no information is lost across retries and approvals.
    """
